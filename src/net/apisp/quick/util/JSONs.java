...
public class JSONs {
		...
		public String toString() {
			...
			for (int i = 0; i < listPairs.size(); i++) {
				...
				for (int j = 0; j < l.size(); j++) {
					...
					} else if (pojoClass.equals(List.class)) {} else {
	...
	private static final JSON parse(Object pojo) {
		...
		if (pojoClass.equals(Integer.class) || pojoClass.equals(int.class) || pojoClass.equals(Double.class)
				...
				|| pojoClass.equals(short.class)) {} else if (pojoClass.equals(String.class)
						|| pojoClass.equals(Date.class)) {
			return null;
	...
	public static final Object convert(String pojo) {
