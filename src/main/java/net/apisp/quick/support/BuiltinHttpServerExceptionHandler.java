 ...
 */
public class BuiltinHttpServerExceptionHandler implements HttpServerExceptionHandler {
    ...
    public void handle(HttpRequest req, HttpResponse resp, Throwable e) {
        ...
        resp.header("Content-Type", MimeTypes.HTML + ";charset=" + serverContext.charset());
    }
